...
if(empty($_SESSION['login'])){
    ...
    if(isset($_POST['upload'])){
        ...
        $upquery = "INSERT INTO `slides` (`photo`) VALUES('$fileo')";
...
// if everything is ok, try to upload file
    ...
    if(isset($_POST['del'])){
        $picto = $_POST['pict'];
        mysqli_query($conn, "DELETE FROM `slides` WHERE `slides`.`photo` = '$picto'");
        unlink(realpath('/project/slides/'.DIRECTORY_SEPARATOR.$filename));
        header("Refresh:0");
    }
}
?>
                            ...
                            <div class="col-lg-12">
                                <form role="form" action="" enctype="multipart/form-data" method="post" >
                                    <div class="form-group">
                                        ...
                                        <p class="danger">Make sure every image has the same resolution ratio! ideal is 3:1 or 1350x450</p>
                                    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        while($pic = mysqli_fetch_assoc($fetch_slides)){
                            ?>
                            <div class="col-lg-3">
                                <img class="img-rounded img-responsive img-thumbnail" src="../../slides/<?php echo $pic['photo']; ?>">
                                <div class="caption">
                                    <p><?php echo $pic['id'];?></p>
